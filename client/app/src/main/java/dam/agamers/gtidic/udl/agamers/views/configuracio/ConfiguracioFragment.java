...
public class ConfiguracioFragment extends Fragment {
    ...
    private ConfiguracioViewModel configuracioViewModel;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        configuracioViewModel =
                new ViewModelProvider(this).get(ConfiguracioViewModel.class);
        ...
        configuracioViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
